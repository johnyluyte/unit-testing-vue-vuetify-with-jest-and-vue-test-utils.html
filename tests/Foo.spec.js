...
describe("Foo", function() {
  ...
  it("does not display element if there are no items", () => {
    ...
    // setProps() here to override it with an empty array of tiems to
  ...
  it("displays .item-index-row when there are items", () => {
    ...
    // wrp.setProps({ apple: "bar" });
    // expect(wrp.vm.apple).toBe("bar");
    console.log(wrp.vm.items);
  ...
  it("should render btn as anchor tag with proper edit url", () => {
    // Not using setProps() here. Just assume we have some items in
